...
export class TransmissionClient {
	 ...
	 */
	public get<K extends keyof Torrent>(args?: GetTorrentArgs<K>) {
	 ...
	 */
	public add(args: AddTorrentArgs) {
		const {
			downloadDir,
			peerLimit,
			filesWanted,
	 ...
	 */
	public remove(ids: ID, deleteLocalData?: boolean) {
	 ...
	 * @returns A promise resolving when the operation is complete.
	 */
	public move(id: ID, location: string, move?: boolean) {
	 ...
	 * @returns A promise resolving when the operation is complete.
	 */
	public set(args: TorrentSetArgs) {
		const {
			bandwidthPriority,
			downloadLimit,
			downloadLimited,
	 ...
	 * @returns A promise resolving when the operation is complete.
	 */
	public renamePath(id: ID, path: string, name: string) {
